...
import { deterministicTrimSystemPrompt, } from "./trim.js";
import { exportGenericSystem, exportClaudeSystem, } from "./targets/genericSystem.js";
...
export function exportPersona(compiledPersona, target) {
    const trimResult = deterministicTrimSystemPrompt(compiledPersona);
    switch (target) {
        case "generic_system":
        ...
        default:
            throw new ExporterError("INVALID_TARGET", `Unknown export target "${String(target)}".`);
    }
}
