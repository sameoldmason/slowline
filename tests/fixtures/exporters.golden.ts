import type { ExporterTarget } from "../../src/persona-engine/exporters/index.js";
import type {
...
} from "../../src/persona-engine/schema/types";
import type { ModuleId } from "../../src/persona-engine/registry/moduleRegistry";
...
export const GOLDEN_CHATGPT_CUSTOM_INSTRUCTIONS: ChatGPTCustomInstructionsPayload =
  {
    what_chatgpt_should_know: "",
    how_chatgpt_should_respond: GOLDEN_SYSTEM_PROMPT,
  };

export const GOLDEN_JSON_BOT_PACK: JsonBotPackPayload = {
...
export const GOLDEN_FILENAMES: Record<ExporterTarget, string> = {
...
export const GOLDEN_RESOLVED_CONFIG: ResolvedPersonaConfig = {
  schemaVersion: "v1",
  tone: "Warm",
  pacing: "Slow",
  jobs: ["focus session", "writing"],
...
export const GOLDEN_DERIVED_FIELDS: DerivedPersonaFields = {
  primaryJob: "focus session",
  toneDescription: "Warm",
  pacingDescription: "Slow",
};

export const GOLDEN_MODULES: CompiledModule[] = (() => {
...
export const GOLDEN_COMPILED_PERSONA: CompiledPersona = {
